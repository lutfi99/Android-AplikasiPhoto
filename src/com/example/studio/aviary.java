...
public class aviary extends Activity {
	...
	private class HDAsyncTask extends AsyncTask<Cursor, Integer, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progress_ = new ProgressDialog( aviary.this );
		...
		protected void onPostExecute( String errorString ) {
			...
			if ( null != errorString ) {
				Toast.makeText( aviary.this, "There was an error: " + errorString, Toast.LENGTH_SHORT ).show();
				return;
			}
			...
			new AlertDialog.Builder( aviary.this ).setTitle( "File saved" )
		...
		private boolean loadImage( MoaHD moa ) throws AviaryExecutionException {
			final String srcPath = IOUtils.getRealFilePath( aviary.this, uri_ );
			if ( srcPath != null ) {
	...
	class DownloadAsync extends AsyncTask<Uri, Void, Bitmap> implements OnCancelListener {
		...
		protected void onPreExecute() {
			...
			mProgress = new ProgressDialog( aviary.this );
		...
		protected Bitmap doInBackground( Uri... params ) {
			...
			bitmap = DecodeUtils.decode( aviary.this, mUri, imageWidth, imageHeight, sizes );
			return bitmap;
		}
		...
		protected void onPostExecute( Bitmap result ) {
			...
			if ( result != null ) {
				...
				Toast.makeText( aviary.this, "Failed to load image " + mUri, Toast.LENGTH_SHORT ).show();
			}
		}
