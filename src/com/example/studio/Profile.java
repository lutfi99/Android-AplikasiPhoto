...
public class Profile extends Activity {
	...
	private class HDAsyncTask extends AsyncTask<Cursor, Integer, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progress_ = new ProgressDialog( Profile.this );
		...
		protected void onPostExecute( String errorString ) {
			...
			if ( null != errorString ) {
				Toast.makeText( Profile.this, "There was an error: " + errorString, Toast.LENGTH_SHORT ).show();
				return;
			}
			...
			new AlertDialog.Builder( Profile.this ).setTitle( "File saved" )
		...
		private boolean loadImage( MoaHD moa ) throws AviaryExecutionException {
			final String srcPath = IOUtils.getRealFilePath( Profile.this, uri_ );
			if ( srcPath != null ) {
	...
	class DownloadAsync extends AsyncTask<Uri, Void, Bitmap> implements OnCancelListener {
		...
		protected Bitmap doInBackground( Uri... params ) {
			...
			bitmap = DecodeUtils.decode( Profile.this, mUri, imageWidth, imageHeight, sizes );
			return bitmap;
		}
		...
		protected void onPostExecute( Bitmap result ) {
			...
			if ( result != null ) {
				...
				Toast.makeText( Profile.this, "Failed to load image " + mUri, Toast.LENGTH_SHORT ).show();
			}
		}
